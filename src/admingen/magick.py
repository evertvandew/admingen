...
Shamefull downloaded from https://raw.githubusercontent.com/ahupp/python-magic/master/magic.py
It was released under the MIT license, https://github.com/ahupp/python-magic/blob/master/LICENSE
"""
